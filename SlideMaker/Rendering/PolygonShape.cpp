...
/*
void drawRegularPolygon(QPainter *painter, int sideCount, const QRectF &boundingRect) {
    // Calculate the center of the bounding rectangle
    QPointF center = boundingRect.center();

    // Calculate the radius of the circumcircle (circle that passes through all vertices) of the polygon
    qreal radius = qMin(boundingRect.width(), boundingRect.height()) / 2.0;
