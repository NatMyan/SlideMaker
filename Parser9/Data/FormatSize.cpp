...
FormatSize::FormatSize() {
    formats_["A0"] = {84.1, 118.9};
    formats_["A1"] = {59.4, 84.1};
    formats_["A2"] = {42, 59.4};
    formats_["A3"] = {29.7, 42};
    formats_["A4"] = {21, 29.7}; 
    formats_["A5"] = {14.85, 21};
    formats_["A6"] = {10.5, 14.85};
    formats_["A7"] = {7.4, 10.5};
    formats_["A8"] = {5.2, 7.4};
    formats_["A9"] = {3.7, 5.2}; 
    formats_["A10"] = {3.7, 5.2};
}

std::pair<std::string, std::pair<double, double> > FormatSize::createFormatSize(const std::string& formatName) {
    if (formats_.find(formatName) != formats_.end()) { return {formatName, formats_[formatName]}; }
    else { throw InvalidFormatException("Format name not found: " + formatName); }
}
...
/*if (formatName == "A0") return {"A0", {84.1, 118.9}};
    ...
    else if (formatName == "A10") return {"A10",  {3.7, 5.2}};*/