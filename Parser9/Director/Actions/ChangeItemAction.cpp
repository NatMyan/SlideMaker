...
void ChangeItemAction::changeItemStuff(std::shared_ptr<IItem> itemInterfacePtr, Map info) {
...
void ChangeItemAction::getItemStuff(std::shared_ptr<IItem> itemInterfacePtr) {
